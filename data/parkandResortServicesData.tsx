// data/parkandResortServicesData.tsx
...
// 👇 This is the dataset that matches what ParkandResortServices expects
export const servicesData = [
  {
    id: "retirement-planning",
    imgSrc: "/image/section/2149033168 1.png",
    imgWidth: 585,
    imgHeight: 439,
    title: "Adventure & Movement",
    description:
  ...
  },
  {
    ...
    imgSrc: "/image/section/2149080766 1.png",
    imgWidth: 878,
    imgHeight: 659,
    title: "Nature & Wellness",
    description:
      "Receive expert guidance on building a diversified investment portfolio aligned with your goals and risk profile.",
    benefits: [
      "Fishing",
      "Gardening",
      "Animal exploration",
  ...
  {
    id: "estate-planning",
    imgSrc: "/image/section/64633 1.png",
    imgWidth: 878,
    imgHeight: 659,
    title: "Crafts & Skills",
    description:
      "Protect your assets and ensure a smooth transfer of wealth to future generations with a robust estate plan.",
    benefits: [
      "Honey making",
      "Jewel extraction",
  ...
  {
    id: "tax-optimization",
    imgSrc: "/image/section/2149572836 1.png",
    imgWidth: 878,
    imgHeight: 659,
    title: "Sports & Precision Activities",
    description:
      "Reduce your tax liabilities with smart, compliant strategies tailored to your income and investment structure.",
    benefits: [
      "Archery",
...
// 👇 This is the critical export your component imports
export const parkandResortServicesData = servicesData;

// Optional: keep this if you use it elsewhere in the app
