...
export default async function UrbanVillagePage() {
  const urbanVillageBrand: any = await getPageByName({
  ...
  if (!urbanVillageBrand) {
    return <div>Failed to load page data.</div>;
  }

  const sectionOne = urbanVillageBrand?.section?.[0];
  ...
  return (
    <div className="kidz-page">
      ...
      <div className="kidz-hero">
        <Image
          src={getStrapiMediaUrl(urbanVillageBrand.Hero.image)}
          alt="Urban Village Hero"
          width={1920}
          height={1080}
            ...
            <div className="col-12">
              <div className="blog-content blog-details-2-content blog-details-content kidz-main__wrap">
                ...
                <ProjectGallery
                  ...
                  altPrefix="Urban Village"
                  className="urbanvillage-gallery"
                  sliderClassName="urbanvillage-slider"
                />
