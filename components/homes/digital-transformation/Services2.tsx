...
export default function Services2() {
  // Use only the first item as the default
  const first = caseStudiesData[0];
                ...
                */}
                ...
                <div className="tab-content">
                  ...
                  >
                    <div className="section-services-item">
                      <div className="image">
                        {/* The empty link wrapper (kept) */}
                        <a href="#" className="link" />
                        <Image
                          src={first.imgSrc}
                          alt={first.title}
                          className="lazyload"
                          width={first.imgWidth}
                          height={first.imgHeight}
                        />
                      </div>
                  ...
                  {/*
                  ===== Commented out: other panes =====
                  {caseStudiesData.slice(1).map(({ id, imgSrc, imgWidth, imgHeight, title, description, benefits, isActive }) => (
                    <div key={id} className={`tab-pane${isActive ? " active show" : ""}`} id={id} role="tabpanel">
                      ...same markup...
                    </div>
                  ))}
                  */}
