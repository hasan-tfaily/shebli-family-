    ...
    <section className="section-map tf-spacing-3">
      <div className="wg-map">
        <div className="box-map">
          <div id="map" className="map">
            <iframe
              src="https://www.google.com/maps?q=D-Ring%20Road%201st%20%26%202nd%20Floors%2C%20Al%20Mataar%2C%20Al%20Qadeem%20District%2C%20Doha%2C%20Qatar&output=embed"
